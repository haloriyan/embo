...
<head>
    ...
    <title>Keyboard Event - Dokumentasi EmboJS</title>
...
<div class='kiri'>
    <div class='wrap'>
        ...
        <div class='menu' id='menuJs'>
            ...
            <a href="#" class='active'><li>Keyboard Event</li></a>
...
<div class='container'>
    <div class="wrap">
        ...
        <div class="code">
            &lt;script&gt;<br />
            tekan("e", () => {<br />
            &nbsp; &nbsp; &nbsp; alert('kamu menekan tombol e')<br />
            })<br />
            &lt;/script&gt;
        </div>
        <div>
        ...
        <h3>Kombinasi Tombol</h3>
        <div class="code">
            &lt;script&gt;<br />
            tekan("alt e", () => {<br />
            &nbsp; &nbsp; &nbsp; alert('kamu menekan tombol alt + b')<br />
            })<br />
            &lt;/script&gt;
        </div>
        <div>
            Test : Tekan tombol "alt" dan "b" secara bersamaan
        </div>
        <p>
            Catatan : keyboard event tidak dapat digunakan pada kombinasi tombol yang sudah diatur secara default oleh browser, seperti ctrl+r dan ctrl+e
        </p>
        <a href='./ajax-js'><button class='tbl merah-2'>Lanjut ke : AJAX</button></a>
    </div>
</div>
...
<script>
    ...
    tekan("alt b", () => {
        alert('kamu menekan tombol alt + b')
    })
</script>
